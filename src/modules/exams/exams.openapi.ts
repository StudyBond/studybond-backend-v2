...
export const examSessionPayloadSchema = z
  .object({
...
export const examResultPayloadSchema = z
  .object({
    examId: z.number().int().positive(),
    examType: z.string(),
    subjects: z.array(z.string()),
...
export const examHistoryPayloadSchema = z
  .object({
...
export const examAbandonPayloadSchema = z
  .object({
    examId: z.number().int().positive(),
    status: z.string(),
    message: z.string(),
...
export const examEligibilityPayloadSchema = z
  .object({
...
export const syncExamResultSchema = z
  .object({
    examId: z.number().int().positive(),
    success: z.boolean(),
...
export const syncExamsPayloadSchema = z
  .object({
